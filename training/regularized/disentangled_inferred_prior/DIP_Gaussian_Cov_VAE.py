...
from training.regularized.disentangled_inferred_prior.DIP_Covariance_VAE import DIP_Cov_VAE
class DIP_Gaussian_Cov_VAE(DIP_Cov_VAE):
    def __encode__(self, **kwargs):
        ...
        covariance_regularizer = self.regularize(encoded['inference_mean'], encoded['inference_logvariance'])
