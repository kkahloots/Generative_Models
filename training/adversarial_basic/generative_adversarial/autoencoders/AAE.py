...
from graphs.adversarial.AAE_graph import generative_discriminate_encode_fn
...
class AAE(autoencoder):
    ...
    def create_batch_cast(self, models):
        def batch_cast_fn(batch):
            ...
            encoded = autoencoder.encode(self, inputs={'inputs': x})
            return {'inference_inputs': x, 'generative_inputs': encoded['z_latent'] },outputs_dict
