...
from graphs.disentangled_inferred_prior.AE_graph import create_regularized_Bayesian_losses
...
class Bayesian_Covariance_AE(basicAE):
    ...
    def __encode__(self, **kwargs):
        ...
        covariance_mean, covariance_regularizer = infer_prior(latent_mean=encoded['z_latents'], \
