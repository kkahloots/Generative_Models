...
from stats.tranditional_adversarial_losses import create_latent_adversarial_real_losses, create_latent_adversarial_fake_losses, create_latent_adversarial_losses
    ...
    def together_cast_batch(self,  xt0, xt1):
        ...
        return {   'inference_inputs': xt0,
                   'generative_inputs': en['x_latent']} ,\
               {
                   'x_logits': xt1,
                   'inputs_real_discriminator_outputs': tf.ones(shape=[self.batch_size, 1], name='real_true'),
                   'inputs_fake_discriminator_outputs': tf.zeros(shape=[self.batch_size, 1], name='fake_true')
               }
