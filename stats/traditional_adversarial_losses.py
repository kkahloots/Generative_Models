...
def create_inputs_adversarial_discriminator_real_losses():
    return {
        'inputs_adversarial_discriminator_real_outputs': real_bce_fn,
    }

def create_inputs_adversarial_discriminator_fake_losses():
    return {
        'inputs_adversarial_discriminator_fake_outputs': fake_bce_fn,
    }

def create_latent_adversarial_discriminator_real_losses():
    return {
        'latent_adversarial_discriminator_real_outputs': real_bce_fn,
    }

def create_latent_adversarial_discriminator_fake_losses():
    return {
        'latent_adversarial_discriminator_fake_outputs': fake_bce_fn,
    }

def create_latent_adversarial_generator_fake_losses():
    return {
        'latent_adversarial_generator_fake_outputs': gfake_bce_fn,
    }
